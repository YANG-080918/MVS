...
def apply_rfm(num, den, x, y, z):
    ss1=apply_poly(num, x, y, z)
    ss2=apply_poly(den, x, y, z)
    # print('apply_rfm分子:',ss1)
    # print('apply_rfm分母:',ss2)
...
class RPCModel:
    ...
    def projection(self, lon, lat, alt):
        ...
        # print('col_offset:', self.col_offset)
        # print('row_scale:', self.row_scale)
        # print('row_offset:', self.row_offset)
        # print('lat_scale:', self.lat_scale)
        # print('lat_offset:', self.lat_offset)
        # print('lon_scale:', self.lon_scale)
        # print('lon_offset:', self.lon_offset)
        # print('alt_scale:', self.alt_scale)
        # print('alt_offset:', self.alt_offset)
        # print('row_num:', self.row_num) 
        # print('row_den:', self.row_den)
        # print('col_num:', self.col_num)
        # print('col_den:', self.col_den)
